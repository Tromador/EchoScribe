...
use crate::{
    artifacts::{
        ...
        LEGACY_TRACK_MANIFEST_FORMAT_VERSION, LEGACY_TRANSCRIPT_FORMAT_VERSION,
        LEGACY_TRANSCRIPTION_RESULT_FORMAT_VERSION, LEGACY_WORK_ITEM_MANIFEST_FORMAT_VERSION,
        PACKET_JOURNAL_FILE_NAME, PARTICIPANT_SNAPSHOT_FILE_NAME,
    ...
    pub(crate) fn validate(&self) -> io::Result<()> {
        ...
        if self.format == RETRANSCRIPTION_SESSION_FORMAT_VERSION {
            ...
            if !matches!(
                ...
                transcript.format,
                LEGACY_TRANSCRIPT_FORMAT_VERSION | TRANSCRIPT_FORMAT_VERSION
